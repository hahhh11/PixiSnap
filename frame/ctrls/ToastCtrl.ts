...
export class ToastCtrl {
	...
	private static _instance: ToastCtrl | null;
	static get instance() {
	...
	showToast(message: string, duration?: number) {
		if (!this.toast) {
			console.warn('ToastCtrl not initialized. Call init() first.');
			return;
		}
...
// 快捷方法
export const showToast = (message: string, duration?: number) => ToastCtrl.instance.showToast(message, duration);
export const hideToast = () => ToastCtrl.instance.hideToast();
export const hideToastImmediately = () => ToastCtrl.instance.hideToastImmediately();
export const destroyToast = () => ToastCtrl.instance.destroy();
